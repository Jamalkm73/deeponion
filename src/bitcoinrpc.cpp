...
static const CRPCCommand vRPCCommands[] =

    {
	    ...
	    {"network",           "listservicenodes",       &listservicenodes,       true,   false},
	    ...
	    {"wallet",            "createmultisig",         &createmultisig,         true,   true },
	    ...
	    {"wallet",            "getlastanontxinfo",      &getlastanontxinfo,      true,   false},
